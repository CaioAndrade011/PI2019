...
public class servico extends javax.swing.JFrame {
    ...
    public servico() {
        ...
        tb_servicos.getTableHeader().setFont(new Font("Arial", Font.BOLD, 12));
        tb_servicos.getTableHeader().setOpaque(false);
        tb_servicos.getTableHeader().setBackground(new Color(0,120,215));
        tb_servicos.getTableHeader().setForeground(new Color(255,255,255));
        tb_servicos.setRowHeight(25);
        
        try{
        ServicosDao listarServicos = new ServicosDao();
        
        List<Servicos> lista = listarServicos.listar();
        DefaultTableModel model = new DefaultTableModel();
        this.tb_servicos.setModel(model);
        model.setColumnIdentifiers(new Object[]{"Id", "Nome", "Valor", "Descricao"});
        
        for(Servicos servico: lista){
                model.addRow(new Object[]{servico.getId(),
                    servico.getNome(),
                    servico.getValor(),
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel2);
        jLabel2.setBounds(220, 20, 140, 43);
        ...
        jButton1.setToolTipText("Cadastrar novo serviço");
        ...
        jButton3.setToolTipText("Editar serviço");
        ...
        jButton4.setToolTipText("Excluir serviço");
        ...
        tb_servicos.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        tf_pesquisa.setToolTipText("Procurar serviço");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        novoServico novoservicoFrame = new novoServico();
        novoservicoFrame.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (linha != -1) {
            ...
            if (resp == JOptionPane.YES_OPTION) {
                int id = (Integer)tb_servicos.getModel().getValueAt(linha, 0);
            
                try {
                Servicos servico = new Servicos();
                servico.setId(id);
                ServicosDao excluir = new ServicosDao();
                excluir.excluir(servico);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      if (linha != -1) {
          int id = (Integer)tb_servicos.getModel().getValueAt(linha, 0);    
          novoServico novoServicoFrame = new novoServico(id);
          novoServicoFrame.setVisible(true);
    ...
    private void tf_pesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_pesquisaKeyReleased
        ...
        List<Servicos> lista = listarServicos.listarTabela(tf_pesquisa.getText());
        DefaultTableModel model = new DefaultTableModel();
        this.tb_servicos.setModel(model);
        model.setColumnIdentifiers(new Object[]{"Id","Nome", "Valor","Descricão"});
        
        for(Servicos servicos: lista){
                model.addRow(new Object[]{servicos.getId(),
                    servicos.getNome(),
                    servicos.getValor(),
